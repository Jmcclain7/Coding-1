...
# the door, and if the code mathces the code in the 
# program, the user may enter, but if it doe not
# match, their credentials will be rejected. The
# client has provided you with the passscode that
# users must use to enter

# Passcode that must be useed: "get_this_money"

def dootEntranceCode(userPin):
    pinCode = 12345
    ifuserPin == pinCode:
        print(access)
